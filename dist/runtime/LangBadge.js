...
import { FaJavaBrands as FaJava, FaDockerBrands as FaDocker, SiJavascript, SiTypescript, SiCplusplus, SiDart, SiCmake, SiSwift, SiKotlin, SiSass, SiPython, SiSharp, SiGo, SiRust, SiPhp, SiCss, SiHtml5, SiReact, SiVuedotjs, SiNextdotjs, SiTailwindcss, TbBrandMysql, DiMicrosoftsqlserverPlain as DiMsqlServer } from './icon-set.js';
...
const normalize = (lang) => lang.trim().toLowerCase().replace(/\+/g, 'plus').replace(/#/g, 'sharp');
export function LangBadge({ lang }) {
    ...
    if (!IconComponent) {
        return (_jsx("span", { className: "dp-project-badge-text", title: lang, children: lang }));
    }
    return (_jsx("span", { className: "dp-project-badge", style: { color, fontSize: '1.2rem' }, title: lang, children: _jsx(IconComponent, {}) }));
}
